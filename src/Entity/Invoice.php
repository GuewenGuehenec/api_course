 ...
 *              "description"="Incrémente le chono d'une facture donnée"
 *          }
 *        }
 *     },
 *     attributes={
...
class Invoice
{
     ...
     * @Assert\NotBlank(message="Le montant de la facture est obligatorie")
     ...
     * @Assert\NotBlank(message="Le client de la facture doit être rensigné")
     */
    private $customer;
     ...
     * @Assert\Type(type="numeric", message="Le chrono doit être un nombre !")
     */
    private $chrono;
